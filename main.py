...
def find_reservation(month, day) -> str:
    ...
    if day < 10:
        day = '0' + str(day)
    link = "https://resy.com/cities/ny/carbone?date=2022-{}-{}&seats=2".format(month, day)
    print("MAKING CALL TO:", link)
    DRIVER.get(link)

    time.sleep(2)

    DRIVER.find_element(By.XPATH, "/html/body/div[1]/main/div/div[2]/div/article[1]/section[1]/resy-inline-booking/div/div/div[3]/div/resy-reservation-button-list")

    return link

def send_email(month, day, link):
    month_map = {1: "January", 2: "February"}
    message = "CARBONE HAS AN OPENING ON " + month_map[month] + " " + str(day) + ". Make a reservation at: " + link
